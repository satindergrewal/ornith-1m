...
class GPUModelRunner(
    ...
    def capture_model(self) -> int:
        ...
        # EXL3 (ornith patch): pre-warm exl3_gemm autotune for every
        # capture-size m-bucket before capture. No-op unless
        # VLLM_EXL3_GRAPH_SAFE=1 and EXL3 layers registered.
        try:
            ...
            logger.warning("EXL3 graph prewarm failed: %s", exc)
